...
export function ChecklistWizard() {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      {/* Template PDF (Escondido num container pai, para o html2pdf clonar o filho sem herdar a posição negativa) */}
      {savedData && (
        <div
          style={{
            position: "absolute",
        ...
        >
          <div ref={pdfRef} className="w-[210mm] bg-white text-black p-8">
            <div className="space-y-6">
              ...
              <div style={{ pageBreakInside: "avoid" }}>
                ...
                {savedData.moveis.map((movel, index) => (
                  ...
                  >
                    ...
                    <p>
                      Largura: {movel.largura}cm | Altura: {movel.altura}cm |
                      Profundidade: {movel.profundidade}cm
                    </p>
                  </div>
                ))}
              </div>
              ...
              {savedData.eletrodomesticos.length > 0 && (
                <div style={{ pageBreakInside: "avoid" }}>
                  ...
                  {savedData.eletrodomesticos.map((eletro, index) => (
                    <p key={index}>
                      • {eletro.nome} {eletro.modelo && `- ${eletro.modelo}`}
                    </p>
                  ))}
                </div>
              )}
              ...
              <div style={{ pageBreakInside: "avoid" }}>
                ...
                <p>
                  <strong>MDF:</strong>{" "}
                  {savedData.preferenciaMateriais.corPadraoMdf}
                </p>
                <p>
                  <strong>Puxador:</strong>{" "}
                  {savedData.preferenciaMateriais.tipoPuxador}
                </p>
              </div>
              ...
              <div style={{ pageBreakInside: "avoid" }}>
                ...
                <p>
                  Corrediças:{" "}
                  {savedData.composicaoProjeto.teraCorredicas ? "Sim" : "Não"}
                </p>
                <p>
                  Gavetas:{" "}
                  {savedData.composicaoProjeto.teraGavetas ? "Sim" : "Não"}
                </p>
                <p>
                  Portas:{" "}
                  {savedData.composicaoProjeto.teraPortas ? "Sim" : "Não"}
                </p>
                <p>
                  Fita LED:{" "}
                  {savedData.composicaoProjeto.teraFitaLed ? "Sim" : "Não"}
                </p>
              </div>
              ...
              {/* Assinatura */}
              <div
                style={{ pageBreakInside: "avoid", pageBreakBefore: "auto" }}
              >
                <h2 className="text-xl font-bold text-gray-800 mb-3">
